...
- /signal-commit|push|pr: follow `skills/signal-commit|push|pr.min.md`
- /signal-review: follow `skills/signal-review.min.md` (1-line + sev)
- /signal-diff|search: follow `skills/signal-diff|search.min.md`

## ⚡ Coding & Testing (Karpathy+)
- Logic Δ: !reproduce ⊕ !test ⊕ !verify
- surgical updates | ∅filler | ∅unrelated_refactor
- Ref: `signal/references/karpathy-coding-norms.md`

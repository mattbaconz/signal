...
name: signal-push
description: >
  Stages all changes, commits with an auto-generated conventional commit message,
  then pushes to remote. One command for the full local→remote cycle. Use when
  user types /signal-push, "commit and push", "push everything", "push my changes",
  or wants to send current changes to remote without manual steps.

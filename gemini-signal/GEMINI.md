# ⚡ SIGNAL (v0.4.0) — Gemini CLI

Brutalist token compression. §CORE⊂`../skills/signal-core.min.md`.

## ⚡ Session Defaults (S3)
- !ALWAYS ACTIVE: S3 rules apply by default for every reply.
- `signal3` == `/signal3` == reset to S3; no per-turn prefix required.
...
- /signal-compress: follow `../skills/signal-compress.min.md`

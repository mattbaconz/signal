...
description: >
  ...
  pushes to remote, then opens a pull request with an auto-generated title and
  body derived from the diff and commit history. Use when user types /signal-pr,
  "open a PR", "create pull request", "ship a PR", "make a PR". Requires gh CLI.

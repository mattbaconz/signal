...
name: signal-review
description: >
  Performs a code review using SIGNAL's compressed template format. Output is
  typed, structured, and chainable — not prose paragraphs. Each issue is one line.
  Use when user types /signal-review, "review this", "review my code", "check this
  PR", "review this file", or asks for a code review on any file, diff, or PR.
